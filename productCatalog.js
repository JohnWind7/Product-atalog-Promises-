...
function processSearch_type(searchType){
...
document.getElementById("inputButton_type").addEventListener('click',function(){
    processSearch_type(document.getElementById('input_type').value);
});

function processSearch_price(searchPrice){
...
document.getElementById("inputButton_price").addEventListener('click',function(){
